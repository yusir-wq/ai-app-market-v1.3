  ...
  return (
    <div className="mb-8">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        上传图片，AI 自动分析画面并生成高质量动态视频，支持多种运镜效果与比例，让静态图片焕发动态生命力！
      </p>
    </div>
  )
}
...
const steps = [
  ...
  },
  {
    icon: ImagePlay,
    title: 'AI 运镜创作',
    desc: 'AI 自动理解图片内容，分析画面结构，生成运镜脚本和动态效果。',
  },
  {
    icon: Video,
    title: '预览下载',
...
const scenarios = [
  {
    icon: ShoppingBag,
    title: '广告&营销视频',
    desc: '产品图片动态展示、品牌故事、社交广告，AI快速制作吸引眼球的视频，扩大品牌&个人曝光度',
  ...
  },
  {
    icon: GraduationCap,
    title: '教育&培训视频',
    desc: '教学图片动态化、公共教育、企业培训，AI制作内容丰富的教学视频，提升学习效果',
...
const faqs = [
  {
    q: '如何使用？',
    a: '上传图片，选择视频参数（比例、时长、清晰度、背景音），AI自动分析图片并生成运镜效果，预览后可下载导出。',
  },
  {
    q: '视频质量如何？',
  ...
  {
    q: '支持哪些图片格式？',
    a: '支持 JPG、PNG、WebP、GIF、BMP 等常见图片格式，单张图片最大 100MB。',
  },
  {
    q: '视频时长限制？',
  ...
  {
    q: '可以自定义运镜效果吗？',
    a: '可以，支持平移、缩放、3D视差等多种运镜效果，也可让AI智能推荐最佳效果。',
  },
  {
    q: '数据安全吗？',
    a: '采用端到端加密存储，符合国际合规标准，所有图片仅用于生成视频，绝不外泄。',
  },
]
...
export function AgentImageToVideoIntro() {
  return (
