  ...
  return (
    <div className="relative text-center mb-14 pt-2">
      ...
      <p className="relative text-sm sm:text-base text-muted-foreground max-w-lg mx-auto leading-relaxed mb-6">
        录咖AI语音转文字，精准转写、自动区分发言人，一键生成智能摘要。
        <br />
        每天免费使用1次，会听、会记、更懂你！
      </p>
...
function StepsSection() {
  return (
    <section className="mb-14">
      <SectionTitle
        title="3步极速转写，语音秒变文字"
        subtitle="录咖AI语音转文字，解放双手，专注思考与沟通。"
      />
...
const advantages = [
  {
    icon: Mic,
    title: '精准识别，98%准确率',
    desc: '录咖搭载行业领先的AI语音识别引擎，针对复杂对话、专业术语、口音差异等难点深度优化，转写准确率高达98%。无论是技术研讨会中的专业名词，还是日常交流，均能清晰捕捉，大幅减少人工修正成本，确保关键信息完整呈现。',
    color: 'rose' as const,
  ...
  },
  {
    icon: Users,
    title: '多人对话，智能区分',
    desc: '针对多人对话场景，录咖AI语音转文字可自动识别不同说话人，并在转写文本中清晰标注（如"说话人1、说话人2"），避免内容混淆。无论是团队会议、圆桌讨论还是访谈交流，都能快速理清逻辑，提升信息整理效率。',
  ...
  },
  {
    icon: Globe,
    title: '99+语言，全球通用',
    desc: '支持99+种语言及方言，包括英语、法语、德语、日语、西班牙语等主流语种，以及四川话、粤语等常用方言，满足跨国会议、多语言课程、国际调研等全球化场景需求。无论何种语言环境，录咖AI语音转文字都能精准转写，打破语言壁垒。',
...
function AdvantagesSection() {
  return (
    <section className="mb-14">
      <SectionTitle
        title="录咖AI语音转文字6大核心优势"
        subtitle="精准识别、实时高效、安全可靠，用录咖AI语音转文字解锁语音转写的无限可能！"
      />
...
const faqs = [
  {
    q: '录咖AI语音转文字如何使用？',
    a: '使用录咖AI语音转文字非常简单：上传音视频文件或者选择实时录音，AI即可自动识别并生成文字稿与智能总结，支持在线编辑、复制和多种格式导出。',
  },
  {
    q: '最好用的免费AI语音转文字软件是哪个？',
    a: '最好用的免费AI语音转文字软件是录咖AI语音转文字，每日可免费使用1次。不仅转写准确率高、支持多语言，更拥有一键智能优化等贴心功能，成为众多高效人士的首选。',
  },
  {
    q: '录咖AI语音转文字的准确率如何？',
    a: '录咖AI语音转文字采用领先的识别引擎，在普通话和常见方言场景下均保持98%高准确率，完美满足会议记录等场景语音转换文字需求。',
  },
  {
    q: '录咖AI语音转文字是免费的吗？',
    a: '每位用户每天可免费体验录咖AI语音转文字1次（20分钟内文件）。如需频繁使用或解锁高级功能，可选择开通VIP会员。',
  },
  {
    q: '上传到录咖的音视频数据安全性能保障吗？',
    a: '录咖AI语音转文字承诺保障用户数据安全，采用银行级别加密技术，所有音视频文件仅用于转写处理，绝不外泄。',
  },
  {
    q: '录咖AI语音转文字能否区分不同说话人？',
    a: '可以。录咖AI语音转文字具备自动声纹识别功能，能够智能区分对话中的不同发言人，并支持手动标注修改人物名称。',
  },
  {
    q: '录咖AI语音转文字支持哪些音视频格式？',
    a: '录咖AI语音转文字兼容性强，支持MP4、MP3、WAV、M4A等19种主流音视频格式，满足绝大多数音视频转写需求。',
  },
  {
    q: '录咖AI语音转文字是否支持实时转写？',
    a: '支持。录咖AI语音转文字提供实时录音转写模式，边说边转，适用于会议、访谈、课堂等需要即时文字记录的场合。',
  },
  {
    q: '录咖AI语音转文字是否支持多语种？',
    a: '是的。录咖AI语音转文字除中文外，还支持英语、日语、法语等99种世界主流语言的识别转写。',
  },
  {
    q: '录咖AI语音转文字成功后能否复制导出？',
    a: '可以。使用录咖AI语音转文字生成的文本，支持在线校对与修改，并可随意复制、导出Word常用文档格式使用。',
  },
]
...
function FAQSection() {
  ...
  return (
    <section className="mb-6">
      <SectionTitle
        title="常见问题"
        subtitle="关于录咖免费在线AI语音转文字的常见问题，下方为你解答。"
      />
